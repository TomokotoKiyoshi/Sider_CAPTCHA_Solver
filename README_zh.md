...
一个基于深度学习的高精度滑块验证码识别解决方案，采用**Lite-HRNet-18-FPN**架构和改进的CenterNet检测头，在真实验证码数据集7px内的hit率上达到91.8%，5px内的hit率达到85.7%，在生成验证集的5px内的hit率达到99%+。
...
- **高精度识别**：真实验证码7px误差准确率达**90%+**（v1.1.0），MAE约 15px
